...
import PatientAppointmentsTable from 'tables/PatientAppointmentTable';
...
export default function PatientProfile() {
  ...
  return (
    ...
    >
      ...
      <TabPanel header="Stretnutia">
        <PatientAppointmentsTable patientId={state}></PatientAppointmentsTable>
      </TabPanel>
